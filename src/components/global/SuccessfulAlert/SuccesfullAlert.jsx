...
const Alert = ({ show, mainText, text, onClose }) => {
    useEffect(() => {
        if (show) {
        ...
        <AnimatePresence>
            {show && (
                <motion.div
                    ...
                    className="fixed top-5 left-1/2 transform -translate-x-1/2 bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md z-50"
                    role="alert"
                >
                    <div className="flex">
                        <div className="py-1">
